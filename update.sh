...
git subtree pull --prefix pack/plugins/start/mini https://github.com/echasnovski/mini.nvim.git main --squash
git subtree pull --prefix pack/plugins/start/multiple-cursor https://github.com/brenton-leighton/multiple-cursors.nvim.git main --squash
